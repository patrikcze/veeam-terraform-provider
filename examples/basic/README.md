...
- Reading existing managed servers from VBR
- Creating a WinLocal repository on an existing managed server
- Creating a backup job bound to the repository
...
- `data.veeam_managed_servers.all` - Existing managed servers inventory
- `veeam_repository.basic_repo` - A basic WinLocal backup repository
- `veeam_backup_job.basic_job` - A basic backup job using that repository
